! function(a, d, p) {
	...
	var i, n, h = d.documentElement,
		v = "svg" === h.nodeName.toLowerCase();

	function u(e) {
		var t = h.className,
			n = l._config.classPrefix || "";
		if (v && (t = t.baseVal), l._config.enableJSClass) {
			var r = new RegExp("(^|\\s)" + n + "no-js(\\s|$)");
			t = t.replace(r, "$1" + n + "js$2")
		}
		l._config.enableClasses && (t += " " + n + e.join(" " + n), v ? h.className.baseVal = t : h.className = t)
	}

	function f(e, t) {
		if ("object" == typeof e)
			for (var n in e) i(e, n) && f(n, e[n]);
		else {
			var r = (e = e.toLowerCase()).split("."),
				o = l[r[0]];
			if (2 == r.length && (o = o[r[1]]), void 0 !== o) return l;
			t = "function" == typeof t ? t() : t, 1 == r.length ? l[r[0]] = t : (!l[r[0]] || l[r[0]] instanceof Boolean || (l[r[0]] = new Boolean(l[r[0]])), l[r[0]][r[1]] = t), u([(t && 0 != t ? "" : "no-") + r.join("-")]), l._trigger(e, t)
		}
		return l
	}

	function g() {
		return "function" != typeof d.createElement ? d.createElement(arguments[0]) : v ? d.createElementNS.call(d, "http://www.w3.org/2000/svg", arguments[0]) : d.createElement.apply(d, arguments)
	}
	i = m(n = {}.hasOwnProperty, "undefined") || m(n.call, "undefined") ? function(e, t) {
		...
		function p(e) {
			var t = c[e[n]];
			return t || (t = {}, r++, e[n] = r, c[r] = t), t
		}

		function u(e, t, n) {
			return t || (t = a), s ? t.createElement(e) : (n || (n = p(t)), !(r = n.cache[e] ? n.cache[e].cloneNode() : l.test(e) ? (n.cache[e] = n.createElem(e)).cloneNode() : n.createElem(e)).canHaveChildren || i.test(e) || r.tagUrn ? r : n.frag.appendChild(r));
			var r
		}
		...
		function m(e) {
			e || (e = a);
			var t, n, r = p(e);
			return !h.shivCSS || o || r.hasCSS || (r.hasCSS = !!f(e, "article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")), s || (t = e, (n = r).cache || (n.cache = {}, n.createElem = t.createElement, n.createFrag = t.createDocumentFragment, n.frag = n.createFrag()), t.createElement = function(e) {
		...
		var h = {
			...
			createDocumentFragment: function(e, t) {
				...
				for (var n = (t = t || p(e)).frag.cloneNode(), r = 0, o = d(), i = o.length; r < i; r++) n.createElement(o[r]);
				return n
			},
		...
		function C(s) {
			...
			return void 0 === t[y] && t.add(y), n.attachEvent("onbeforeprint", function() {
				...
				for (; n = a.pop();)
					...
					for (var t, n = e.split("{"), r = n.length, o = RegExp("(^|[\\s,>+~])(" + d().join("|") + ")(?=[[\\s,>+~#.:]|$)", "gi"), i = "$1" + y + "\\:$2"; r--;)(t = n[r] = n[r].split("}"))[t.length - 1] = t[t.length - 1].replace(o, i), n[r] = t.join("}");
					return n.join("{")
				}(o.reverse().join("")), c = function(e) {
					for (var t, n = e.getElementsByTagName("*"), r = n.length, o = RegExp("^(?:" + d().join("|") + ")$", "i"), i = []; r--;) t = n[r], o.test(t.nodeName) && i.push(t.applyElement(E(t)));
					return i
				}(s), l = f(s, o)
	...
	function o(e, t, n, r) {
		var o, i, a, s, l, c = "modernizr",
			u = g("div"),
			f = ((l = d.body) || ((l = g(v ? "svg" : "body")).fake = !0), l);
		if (parseInt(n, 10))
			for (; n--;)(a = g("div")).id = r ? r[n] : c + (n + 1), u.appendChild(a);
		return (o = g("style")).type = "text/css", o.id = "s" + c, (f.fake ? f : u).appendChild(o), f.appendChild(u), o.styleSheet ? o.styleSheet.cssText = e : o.appendChild(d.createTextNode(e)), u.id = c, f.fake && (f.style.background = "", f.style.overflow = "hidden", s = h.style.overflow, h.style.overflow = "hidden", h.appendChild(f)), i = t(u, e), f.fake ? (f.parentNode.removeChild(f), h.style.overflow = s, h.offsetHeight) : u.parentNode.removeChild(u), !!i
	}
	...
	function b(e, t, n, r) {
		...
		for (var i, a, s, l, c, u = ["modernizr", "tspan", "samp"]; !y.style && u.length;) i = !0, y.modElem = g(u.shift()), y.style = y.modElem.style;

		function f() {
			i && (delete y.style, delete y.modElem)
		}
		for (s = e.length, a = 0; a < s; a++)
			if (l = e[a], c = y.style[l], ~("" + l).indexOf("-") && (l = C(l)), y.style[l] !== p) {
				if (r || m(n, "undefined")) return f(), "pfx" != t || l;
				try {
					y.style[l] = n
				} catch (e) {}
				if (y.style[l] != c) return f(), "pfx" != t || l
			} return f(), !1
	}
	...
	var r = "Moz O ms Webkit",
		_ = e._config.usePrefixes ? r.split(" ") : [];
	e._cssomPrefixes = _;
	...
	function T(e, t, n, r, o) {
		...
		return m(t, "string") || m(t, "undefined") ? b(a, t, r, o) : function(e, t, n) {
			var r;
			for (var o in e)
				if (e[o] in t) return !1 === n ? e[o] : m(r = t[e[o]], "function") ? w(r, n || t) : r;
			return !1
		}(a = (e + " " + x.join(i + " ") + i).split(" "), t, n)
	}
	e._domPrefixes = x, e.testAllProps = T;
	var N = function(e) {
		var t, n = j.length,
			r = a.CSSRule;
	...
	e.prefixed = function(e, t, n) {
		return 0 === e.indexOf("@") ? N(e) : (-1 != e.indexOf("-") && (e = C(e)), t ? T(e, t, n) : T(e, "pfx"))
	};
	var j = e._config.usePrefixes ? " -webkit- -moz- -o- -ms- ".split(" ") : ["", ""];
	e._prefixes = j;
	var z = e.testStyles = o;
	l.addTest("touchevents", function() {
			var t;
			if ("ontouchstart" in a || a.DocumentTouch && d instanceof DocumentTouch) t = !0;
			else {
				var e = ["@media (", j.join("touch-enabled),("), "heartz", ")", "{#modernizr{top:9px;position:absolute}}"].join("");
				z(e, function(e) {
					t = 9 === e.offsetTop
				})
			}
			return t
		}), l.addTest("target", function() {
			var e = a.document;
		...
		}), l.addTest("svg", !!d.createElementNS && !!d.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect),
		function() {
			var e, t, n, r, o, i;
			for (var a in s)
				if (s.hasOwnProperty(a)) {
					...
					for (r = m(t.fn, "function") ? t.fn() : t.fn, o = 0; o < e.length; o++) 1 === (i = e[o].split(".")).length ? l[i[0]] = r : (!l[i[0]] || l[i[0]] instanceof Boolean || (l[i[0]] = new Boolean(l[i[0]])), l[i[0]][i[1]] = r), c.push((r ? "" : "no-") + i.join("-"))
				}
		}(), u(c), delete e.addTest, delete e.addAsyncTest;
